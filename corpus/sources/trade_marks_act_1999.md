...
Protects a brand name, logo or other mark used to distinguish one trader's goods or services from another's.
- Register at the Trade Marks Registry (under CGPDTM, DPIIT). Relevant classes for Ayurveda: Class 5 (medicinal/pharmaceutical preparations), Class 3 (cosmetics), Class 29/30/32 (food, nutraceuticals, beverages such as Ayurveda-Aahar products).
- Sec 9 (absolute grounds for refusal): a mark that is purely descriptive, generic, or is the common/customary name of the goods in the trade cannot be registered. A classical formulation's own traditional name, if already used generically for that recipe, risks refusal on this ground.
- Sec 11 (relative grounds): refusal or opposition where the mark conflicts with an earlier registered or well-known mark.
