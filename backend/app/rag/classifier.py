...
IP_KEYWORDS: dict[IPType, re.Pattern] = {
    ...
    IPType.COPYRIGHT: re.compile(r"\b(copyright|©|literary|textbook|manuscript|compilation|authorship|translation)\b", re.I),
    IPType.DESIGN: re.compile(r"\b(design|packaging|ornamental|container|bottle|carton|label shape|appearance)\b", re.I),
    IPType.TRADE_SECRET: re.compile(r"\b(trade secret|secret recipe|secret formula|confidential|know[-\s]?how|nda|non[-\s]?disclosure|undisclosed)\b", re.I),
